          ...
          <section className="relative w-full border-b-2 border-black overflow-hidden bg-[#F0EBE0]">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 lg:p-16 flex flex-col justify-center relative z-10 min-h-[60vh]">
                ...
                <h2 className="font-display font-black text-5xl md:text-8xl lg:text-9xl uppercase leading-[1] mb-6 mix-blend-darken text-fashionBlack">
                  Pure <br/>
              ...
              {/* Hero Image Section */}
              <div className="relative h-[50vh] lg:h-auto bg-cardboard border-l-2 border-black flex items-center justify-center p-12">
                ...
                <img 
                  ...
                  className="w-auto max-h-[70%] max-w-[80%] object-contain drop-shadow-[10px_10px_0px_rgba(0,0,0,0.2)] hover:scale-105 transition-transform duration-500"
                />
              </div>
            </div>
            ...
            <div className="bg-neonGreen border-t-2 border-black py-2 overflow-hidden whitespace-nowrap">
              <div className="animate-marquee inline-block">
                <span className="text-black font-bold font-mono text-lg mx-4">HANDMADE • ORGANIC • RECYCLED • CHIC •</span>
                <span className="text-black font-bold font-mono text-lg mx-4">HANDMADE • ORGANIC • RECYCLED • CHIC •</span>
                <span className="text-black font-bold font-mono text-lg mx-4">HANDMADE • ORGANIC • RECYCLED • CHIC •</span>
                <span className="text-black font-bold font-mono text-lg mx-4">HANDMADE • ORGANIC • RECYCLED • CHIC •</span>
                <span className="text-black font-bold font-mono text-lg mx-4">HANDMADE • ORGANIC • RECYCLED • CHIC •</span> 
        ...
        {!activeCategory && (
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 mb-32">
                <div className="relative py-16 px-8 border-2 border-black bg-neonGreen overflow-hidden">
                    ...
                    <h3 className="font-display text-4xl md:text-6xl font-black uppercase mb-6 leading-none text-black">Recycled. <br/>Radical. Real.</h3>
    ...
    <div className="min-h-screen bg-cardboard selection:bg-neonPink selection:text-white">
      ...
      {cartOpen && (
        <div className="fixed inset-0 z-[120] flex justify-end">
          ...
          ></div>
          <div className="relative w-full max-w-md bg-cardboard h-full shadow-2xl p-6 flex flex-col border-l-4 border-black animate-in slide-in-from-right duration-300">
